...
TABLE 1: The names and description of abbreviated sensor names are given.
|    Name   |                              Description                             |
|:---------:|:--------------------------------------------------------------------:|
